...
const I18N = {
  en: {
    ...
    index: {
      ...
      hero_title_html: '1XBET LATAM <span>Partner Program</span> for Agents and Affiliates',
      ...
      external_platform_cta: 'Get 200% Deposit Bonus',
  ...
  es: {
    ...
    index: {
      ...
      hero_title_html: 'Programa de Socios <span>1XBET LATAM</span> para Agentes y Afiliados',
      ...
      external_platform_cta: 'Obten 200% de bono en tu deposito',
  ...
  pt: {
    ...
    index: {
      ...
      hero_title_html: 'Programa de Parceiros <span>1XBET LATAM</span> para Agentes e Afiliados',
      ...
      external_platform_cta: 'Ganhe 200% de bonus no deposito',
